				...
				<div class="row">
					<div class="col-xs-12">
						<div class="page-title text-center">
							<h1>Delineado del contorno de labios</h1>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-5 col-md-4">
					<div class="service-list single">
						<div class="thumb">
							<img src="img/services/contorno_de_labios.jpg" alt="" />
						</div>
				...
				<div class="col-xs-12 col-sm-7 col-md-8">
					<div class="service-details">
						<h3>Sesión de 90 min.<br/>$1,500.00</h3>
						<p>El delineado del contorno de labios nos ayuda a lucir labios muy naturales y es ideal para hacer correcciones de  forma o color.</p>
