				...
				<div class="row">
					<div class="col-xs-12">
						<div class="page-title text-center">
							<h1>Microdermoabrasión punta de diamante + mascarilla hidratante.</h1>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-5 col-md-4">
					<div class="service-list single">
						<div class="thumb">
							<img src="img/services/microdermoabrasión.jpg" alt="" />
						</div>
						<h2>Microdermoabrasión punta de diamante + mascarilla hidratante.</h2>
