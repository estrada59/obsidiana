<?php
function servicios($var){
    switch($var){
        case 1:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/antifaz_de_juventud.jpg" alt="Antifaz de juventud" />
                    </div>
        ...
        case 2:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/cejas.jpg" alt="Cejas sombreadas o compactas" />
                    </div>
        ...
        case 3:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/contorno_de_labios.jpg" alt="Delineado del contorno de labios" />
                    </div>
        ...
        case 5:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/delineado_parpados_superior.jpg" alt="Delineado de párpado superior" />
                    </div>
        ...
        case 7:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/lash_lifting.jpg" alt="Lash lifting" />
                    </div>
                    <h2>Lash lifting</h2>
        ...
        case 9:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/linea_de_luz.jpg" alt="Línea de luz" />
                    </div>
                    <h2>Línea de luz</h2>
                    <div class="price-text"><sup>$</sup>1,500.00</div>
        ...
        case 10:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/microblading.jpg" alt="Microblading" />
                    </div>
                    <h2>Microblading</h2>
        ...
        case 12:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/pestañas_1x1.jpg" alt="Pestañas 1x1" />
                    </div>
                    <h2>Pestañas 1x1</h2>
        ...
        case 13:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/pestañas_tecnica_mixta.jpg" alt="Pestañas técnica mixta" />
                    </div>
        ...
        case 14:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/pestañas_volumen.jpg" alt="Pestañas volumen" />
                    </div>
        ...
        case 15:
            echo'
                <div class="service-list">
                    <div class="thumb">
                        <img src="img/services/punteado_de_pestañas.jpg" alt="Punteado de pestañas" />
                    </div>
