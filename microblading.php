			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-7 col-md-8">
					<div class="service-details">
						<h3>Sesión 120 min<br/>$3,000.00 1ra sesión <br/> $1000 retoque al mes y medio.<br/>Duración de 9 -12 meses aprox. </h3>
                        <p>Esta técnica consiste micropigmentar las cejar para definir forma y color, "dibujando" pelo por pelo, con un inductor manual.</p>
                        <p>El procedimiento no es doloroso y se recomienda en cejas vírgenes, de vello delgado, escaso, así como en personas jóvenes o adultas que prefieren lucir más naturales durante su vida cotidiana.</p>
