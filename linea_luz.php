			...
			<div class="row">
				<div class="col-xs-12 col-sm-5 col-md-4">
					<div class="service-list single">
						<div class="thumb">
							<img src="img/services/linea_de_luz.jpg" alt="" />
						</div>
						<h2>Línea de luz</h2>
				...
				<div class="col-xs-12 col-sm-7 col-md-8">
					<div class="service-details">
						<h3>Tiempo de procedimiento 90 min<br/>$1,500.00 <br/> Duración de  4 años en adelante. </h3>
                        <p>Consiste en dibujar una delgada linea de color claro, generalmente beige, sobre la linea negra para para resaltar la mirada mediante efecto óptico. </p>
                        <p>Es indispensable hacer primero el delineado negro. </p>
