			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-7 col-md-8">
					<div class="service-details">
						<h3>Full set $1500 | Sesión de 120 a  180min.<br/>Retoque $ 500 | cada 3 semanas</h3>
						<p>Las pestañas efecto Volumen consisten en superponer más de 2 extensiones de pestañas por cada pestaña natural. Esto nos permite aumentar el volumen, la curvatura y la longitud de las pestañas resultantes. </p>
					</div>
				</div>
