			...
			<div class="row">
				<div class="col-xs-12 col-sm-5 col-md-4">
					<div class="service-list single">
						<div class="thumb">
							<img src="img/services/pestañas_tecnica_mixta.jpg" alt="" />
						</div>
				...
				<div class="col-xs-12 col-sm-7 col-md-8">
					<div class="service-details">
						<h3>Full set $1350 | 90min<br/>Retoque $500 |40min </h3>
						<p>Consiste en mezclar las dos técnicas de extensiones de pestañas, 1x1 y volumen, para crear un efecto intermedio. </p>
						<p>Aspecto de volumen muy natural.</p>
					</div>
				</div>
