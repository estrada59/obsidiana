			...
			<div class="row">
				<div class="col-xs-12 col-sm-5 col-md-4">
					<div class="service-list single">
						<div class="thumb">
							<img src="img/services/punteado_de_pestañas.jpg" alt="" />
						</div>
				...
				<div class="col-xs-12 col-sm-7 col-md-8">
					<div class="service-details">
						<h3>Tiempo del procedimiento 60min<br/>$1,000.00 <br/> Duración de 1 a 4 años aprox.</h3>
						<p>Consiste en micropigmentar los espacios entre las pestañas, para simular un efecto óptico de abundantes pestañas.</p>
						<p>Resalta la mirada de forma muy natural. </p>
					</div>
				</div>
