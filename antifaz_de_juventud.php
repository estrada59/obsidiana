			...
			<div class="row">
				<div class="col-xs-12 col-sm-5 col-md-4">
					<div class="service-list single">
						<div class="thumb">
							<img src="img/services/antifaz_de_juventud.jpg" alt="" />
						</div>
				...
				<div class="col-xs-12 col-sm-7 col-md-8">
					<div class="service-details">
						<h3>Sesión de 50 min<br/>$850.00 <br/> *Paquetes según necesidad del paciente.</h3>
						<p>Es un protocolo enfocado en nutrir y reparar la zona más sensible del rostro, el orbicular de ojos. Altamente nutritivo e hidratante y por efecto de cupping (masaje con ventosas) drenante y reafirmante. Microdermoabrasión e hidratación en rostro. </p>
						<p>Ideal para ojos cansados, bolsas parpebrales, lineas de expresión, deshidratación, y ojeras. </p>
					
						<h3>Efectos:</h3>
						<ul>
							<li>Ayuda a drenar bolsas parpebrales.</li>
							<li>Disminuye líneas de expresión.</li>
							<li>Mejora la hidratación y nutrición de la piel.</li>
