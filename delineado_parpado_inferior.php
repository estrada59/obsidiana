				...
				<div class="row">
					<div class="col-xs-12">
						<div class="page-title text-center">
							<h1>Delineado de párpado inferior</h1>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-5 col-md-4">
					<div class="service-list single">
						<div class="thumb">
							<img src="img/services/delineado_parpados_inferior.jpg" alt="" />
						</div>
				...
				<div class="col-xs-12 col-sm-7 col-md-8">
					<div class="service-details">
						<h3>Sesión de 60 min<br/>$1,000.00 <br/> Duración de 1 a 4 años aprox.</h3>
						<p>20% de desc. En delineado de párpado inferior durante la misma sesión.</p>
						<p>El delineado obscuro en el párpado inferior  resalta la mirada y nos ahorra  tiempo de maquillaje. </p>
					</div>
				</div>
