			...
			<div class="row">
				<div class="col-xs-12 col-sm-5 col-md-4">
					<div class="service-list single">
						<div class="thumb">
							<img src="img/services/pestañas_1x1.jpg" alt="" />
						</div>
						<h2>Pestañas 1x1 </h2>
				...
				<div class="col-xs-12 col-sm-7 col-md-8">
					<div class="service-details">
						<h3>Full set $1000 | Sesión 90 min<br/>Retoque $350 | Sesión 40 min</h3>
						<p>Las extensiones de pestañas 1x1, consiste en superponer una extensión de pestaña en una pestaña natural. </p>
						<p>Las extensiones también conocidas como técnica clásica, se recomienda para personas que tengan buen volumen de pestañas naturales, pero que quieran pronunciar su curvatura o longitud.</p>
					</div>
				</div>
